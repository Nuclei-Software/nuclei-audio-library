 ...
 * nframes         Return count of frames, -1 when undefined
 ...
 * nframes         Count of frames, -1 when undefined
 */
 ...
 */
void wave_write_pcm(MemoryFile *fp, int samplesize, const void *pcm, int nch,
                    int off, int count);

...
#define LW_SIGN (INT32)0x80000000       /* sign bit */
#define LW_MIN (INT32)0x80000000
#define LW_MAX (INT32)0x7fffffff

#define SW_SIGN (INT16)0x8000          /* sign bit for Shortword type */
#define SW_MIN (INT16)0x8000           /* smallest Ram */
#define SW_MAX (INT16)0x7fff           /* largest Ram */

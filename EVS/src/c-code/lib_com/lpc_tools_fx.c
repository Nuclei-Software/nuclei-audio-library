                         ...
                         )
{
    ...
    FOR (i = 2; i <= order; i++)
    {
        ...
        if ((mem!=NULL) && ((L_sub(L_abs(t2), 5) < 0)))
        {
            flag=1;

...
)
{
    ...
    FOR (i = 0; i < nb_min; i++)
    {
        ...
        /* Add some samples */
        ftmp = negate(mult(*pt_src,1638/*.05f Q15*/));
...
)
{
    ...
    tmp32 = BASOP_Util_Add_Mant32Exp(L_mult(sub(nFrameLength,add(nSamplesDelta,T0)),freqStart)/*Q16*/,add(freqStart_e,31-16),0x80000000/*-1.f Q31*/,0,&tmp_e);

...
)
{
    ...
    *------------------------------------------------------------------*/
    ...
    move16();
    calc_residu_fx(st_fx, inp, res, Aq, 0, 0);
    ...
    *------------------------------------------------------------------*/
    ...
    IF( sub(L_frame,L_FRAME16k)==0 )
    {
        ...
        find_targets_fx(inp, mem->mem_syn, 0, &mem->mem_w0, Aq, res, L_SUBFR, Ap, PREEMPH_FAC_16k, xn, cn, h1);
    }
    ELSE
    {
    ...
    *-----------------------------------------------------------------*/
    ...
    clip_gain = gp_clip_fx( core_bitrate, voicing, 0, coder_type, xn, st_fx->clip_var_fx, sub(shift_wsp, 1) );
    ...
    *-----------------------------------------------------------------*/
    ...
    gp_clip_test_gain_pit_fx( core_bitrate, gain_pit, st_fx->clip_var_fx );
